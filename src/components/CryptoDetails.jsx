      ...
      <Col className="stats-container">
        <Col className="coin-value-statistics">
          <Col className="coin-value-statistics-heading">
            ...
            <p>An overwiev showing the stats of {data?.data?.coin.name}</p>
          </Col>
        ...
        <Col className="other-stats-info">
          <Col className="coin-value-statistics-heading">
            ...
            <p>An overwiev showing the stats of all cryptocurrencies</p>
          </Col>
      ...
      <Col className="coin-desc-link">
        {/* <Row className="coin-desc">
          <Title level={3} className="coin-details-heading">
            ...
            {HTMLReactParser(data?.data?.coin?.description)}  "First argument must be a string" - ошибка на этой строке кода
        </Row> */}
